...
const INDUSTRIES = [
  { id: "restaurant", label: "Restaurant", emoji: "🍽️", status: "available", subtypes: ["Dine-in", "Takeaway", "Delivery", "Cloud kitchen", "Multi-branch"], defaultSubtypes: ["Dine-in"] },
  { id: "fastfood", label: "Fast Food", emoji: "🍔", status: "available", subtypes: ["Dine-in", "Takeaway", "Delivery", "Drive-thru"], defaultSubtypes: ["Takeaway"] },
  { id: "lounge", label: "Lounge / Bar", emoji: "🍸", status: "available", subtypes: ["Walk-in", "Reservations", "Events", "Delivery"], defaultSubtypes: ["Walk-in"] },
  { id: "hotel", label: "Hotel", emoji: "🏨", status: "soon" },
  { id: "clinic", label: "Clinic", emoji: "🏥", status: "soon" },
  { id: "events", label: "Ticketing & Events", emoji: "🎫", status: "soon" },
];
  ...
  return (
    <div className="efw-page">
      <style>{`
        ...
        .efw-card-thumb { height: 92px; border-radius: 10px; background: var(--bg); display: flex; align-items: center; justify-content: center; font-size: 34px; margin-bottom: 12px; border: 1px solid var(--border-soft); }
        ...
        <div className="efw-grid">
          {INDUSTRIES.map((industry) => {
            ...
            return (
              ...
              >
                <div className="efw-card-thumb">{industry.emoji}</div>
